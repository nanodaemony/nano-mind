...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936193-ef5ebd74-937d-49bb-b628-d23b576ac179.png "null")
...
1. 查看 Todo 列表，缺省情况下，只列出未完成的 Todo 项。
...
```
todo import -f todolist第四阶段：支持数据库持久化在配置文件中，配置数据库连接信息。
```
...
1. 在项目的 README 文件中，写出如何构建和执行你的应用；

2. 需求分成四个阶段，请你按顺序依次完成每个阶段的需求；

3. 每完成一个阶段的代码，创建一个 tag，tag 名称分别为 todo-phase-1、todo-phase-2、todo-phase-3、todo-phase-4。
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936291-39887bf3-b46f-4ce7-b64e-ed2f1f18a3d5.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936343-b780c275-6137-4bba-bc35-d3384512a8e2.png "null")
...
2. 使用不恰当的单词简写（比如，多个单词的首字母，或者写单词其中的一部分）。
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936398-7ee55b29-0a56-4f32-b5bf-a75791669b1e.png "null")
...
**写代码要想做到 DRY，一个关键点是能够发现重复**。发现重复，一种是在泥潭中挣扎后，被动地发现，还有一种是提升自己识别能力，主动地发现重复。这种主动识别的能力，其实背后要有对软件设计更好的理解，尤其是对分离关注点的理解（如果你对“分离关注点”的知识感兴趣，可以参考我在《软件设计之美》中的02讲）。
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936451-d5a33361-77a0-4766-a300-510232f68567.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936511-4e62f7dc-0e8c-412e-a065-3b54872c025c.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936562-d4f103b9-c0f4-44c1-bbcf-fc59f579c4d1.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936617-3721026e-0fd3-4c8e-9ff0-959a2a9cc4b8.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936672-c6e54d9c-aee3-4d36-bb26-db656f6f66bf.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936733-e22fdfb5-aaea-4917-9c13-b7cc0385cf64.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936791-214a5467-ddcd-426c-bce9-7d437ae8b736.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936856-986cc521-9c95-4afa-948e-5907e03185ff.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936908-2427a279-67ed-4319-b0e5-0d15f1a74bbc.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824936971-8e1e756b-884f-409e-bfed-b5f7b06d3f48.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824937028-336b697a-59dd-4974-b283-792683d502ff.png "null")
...
val name = author?.name函数式编程Optional 是 Java 8 引入的新特性，它的出现改变了编写 Java 代码的习惯用法。接下来，我们来看看另外一个改变我们代码习惯用法的特性。
```
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824937087-f4596a21-1986-492d-96ff-d6ca8b05ef0f.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824937155-4e674569-ceec-40c9-b619-fad76a02df1b.png "null")
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824937216-9954dfdd-b50e-48f4-8a87-12058a4468c0.png "null")
...
1. 第一，每个人对于“好”或“美”的观念可能相当不同；

2. 第二，对于坏代码缺乏明确的“症状”判断，也就很难提出明确的改进措施。
...
估计很多人看到这里就会说，如果 static 都成了坏味道，那 Singleton 模式该怎么办呢？答案就是**尽可能不用 Singleton 模式**。我在《软件设计之美》中讲可测试性和设计模式时，都说到过 Singleton 模式，简单地说，系统里只有一个实例和限制系统里只能构建出一个实例，这是两件事，而且，如果一个函数牵扯到 Singleton 类也不好测试。
...
![](https://cdn.nlark.com/yuque/0/2026/png/29379084/1770824937277-b740986e-a936-4b1c-9c60-08e775ad4662.png "null")
