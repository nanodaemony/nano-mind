...
![[yuque-1779533037770-43.png]]

由于我们在数据库中设置的是禁用自动批准授权的模式，所以登录后来到了批准界面：

![[yuque-1779533037964-44.png]]

点击同意后可以看到，数据库中也会产生授权通过记录：

![[yuque-1779533038042-45.png]]
...
![[yuque-1779533038387-48.png]]

访问 /user 需要身份认证：

![[yuque-1779533038489-49.png]]
...
![[yuque-1779533039226-53.png]]

登录后显示了当前用户名和权限：

![[yuque-1779533039353-54.png]]

我们再启动另一个客户端网站，端口改为 8083，然后访问同样的地址：

![[yuque-1779533039537-55.png]]
...
![[yuque-1779533040814-66.png]]

图4 微信开放平台授权流程图

引自微信官方文档

![[yuque-1779533040900-67.png]]

图5 支付宝开放平台授权流程图

引自支付宝开放平台文档

![[yuque-1779533040984-68.png]]
