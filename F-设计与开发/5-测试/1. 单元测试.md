...
![[yuque-1778165456204-1.jpeg|495]]

从上图可以看出如果要对 A 进行测试，那么就要**先把整个依赖树构建出来**，也就是 `BCDE` 的实例。

一种替代方案就是使用 mocks。

![[yuque-1778165456355-2.jpeg|291]]
...
test01 先被执行，打桩前调用 `add(1, 2)` 的结果是0，打桩后是 100。
